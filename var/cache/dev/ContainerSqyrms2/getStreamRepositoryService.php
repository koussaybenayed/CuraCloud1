...
{
    /**
     * Gets the private 'App\Repository\StreamRepository' shared autowired service.
     *
     * @return \App\Repository\StreamRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'StreamRepository.php';

        return $container->privates['App\\Repository\\StreamRepository'] = new \App\Repository\StreamRepository(($container->services['doctrine'] ?? $container->getDoctrineService()), ($container->privates['logger'] ?? ($container->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
}
