 ...
 */
class getMessageStreamRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MessageStreamRepository' shared autowired service.
     *
     * @return \App\Repository\MessageStreamRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MessageStreamRepository.php';

        return $container->privates['App\\Repository\\MessageStreamRepository'] = new \App\Repository\MessageStreamRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
