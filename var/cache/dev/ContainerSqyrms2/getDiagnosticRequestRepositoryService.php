 ...
 */
class getDiagnosticRequestRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DiagnosticRequestRepository' shared autowired service.
     *
     * @return \App\Repository\DiagnosticRequestRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DiagnosticRequestRepository.php';

        return $container->privates['App\\Repository\\DiagnosticRequestRepository'] = new \App\Repository\DiagnosticRequestRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
