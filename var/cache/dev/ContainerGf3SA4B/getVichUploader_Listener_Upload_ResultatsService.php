 ...
 */
class getVichUploader_Listener_Upload_ResultatsService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.upload.resultats' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.upload.resultats'])) {
            return $container->privates['vich_uploader.listener.upload.resultats'];
        }

        return $container->privates['vich_uploader.listener.upload.resultats'] = new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('resultats', ($container->privates['vich_uploader.adapter.orm'] ?? ($container->privates['vich_uploader.adapter.orm'] = new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter())), ($container->privates['vich_uploader.metadata_reader'] ?? $container->getVichUploader_MetadataReaderService()), $a);
    }
}
