 ...
 */
class getMedsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MedsRepository' shared autowired service.
     *
     * @return \App\Repository\MedsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MedsRepository.php';

        return $container->privates['App\\Repository\\MedsRepository'] = new \App\Repository\MedsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
