 ...
 */
class getBilanRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BilanRepository' shared autowired service.
     *
     * @return \App\Repository\BilanRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BilanRepository.php';

        return $container->privates['App\\Repository\\BilanRepository'] = new \App\Repository\BilanRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
