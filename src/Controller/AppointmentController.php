...
class AppointmentController extends AbstractController
{
    ...
    #[Route('/doctor/appointment/complete/{id}', name: 'appointment_completed')]
...
public function newUser(Request $request, EntityManagerInterface $entityManager, AppointmentRepository $appointmentRepository, UserRepository $userRepository, $id_doctor): Response
{
    ...
    #[Route('/submit_rating/{id}', name: 'submit_rating', methods: ['POST'])]
    public function submitRating(Request $request, $id): Response
    {
        ...
        // Update the appointment entity with the submitted rating
        $appointment->setRating($rating);
        $entityManager->flush();

        // Optionally, return a JSON response indicating success
        return $this->json(['message' => 'Rating submitted successfully'], Response::HTTP_OK);
    }
